...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference("Meeting.count") do
      post meetings_url, params: { meeting: { Example: @meeting.Example, start_time: @meeting.start_time } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { Example: @meeting.Example, start_time: @meeting.start_time } }
